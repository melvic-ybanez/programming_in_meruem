...
Note that \code{<function>} is the string representation of a function. The \keyword{string representation} of an expression is the string value returned by applying the \code{to-string} function to that expression.
