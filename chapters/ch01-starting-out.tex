...
In \ikeyword{Object-oriented programming}, you focus on designing objects that represent both the data and the functions that can operate on them. Most object-oriented languages also support imperative programming, and in some cases, we only refer to them as either imperative languages or OO languages. Many languages are actually multi-paradigms (i.e. they support more than one paradigm), but they tend to favour one over the others. 

Java is a good example of a language that supports imperative and OOP. In Java 8, you can even do a little bit of functional programming. Java is usually referred to as an object-oriented language. If you program in Java, you are expected to do it the OOP way. For instance, if you want to create a data structure that represents a person, you can do it like this:
\begin{Java}
	public class Person {
		private String name;
		private int age;
...
There are so many things to learn in object-oriented programming, such as \keyword{inheritance}, {polymorphism}, {encapsulation}, etc. The in-depth discussions of these topics are unfortunately outside the scope of this book.
