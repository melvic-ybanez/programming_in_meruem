...
The \code{hello\_world} is the name of the source file you want to run. A Meruem source file ends with a \code{.mer}. Basically, if the source file is not provided, Meruem will fire up the REPL for you. 
