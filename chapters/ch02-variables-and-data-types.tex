...
\subsection{List}
\code{List} is a collection of things. It is written as a set of space-separated elements enclosed in a pair of parentheses. Each of the elements of the a list is value of another type. Since \code{List} is a type that can be composed of some other types, it is considered as a \code{compound type}. Here are some examples of \code{list}s in Meruem:
